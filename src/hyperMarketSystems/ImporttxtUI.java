...
public class ImporttxtUI extends javax.swing.JFrame 
{
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Click to read txt file");
        ...
        layout.setHorizontalGroup(
        	layout.createParallelGroup(Alignment.LEADING)
        		...
        		.addGroup(layout.createSequentialGroup()
        			.addGap(55)
        			.addComponent(jButton1, GroupLayout.PREFERRED_SIZE, 156, GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseReleased
        ...
        try 
        {
            ...
            while (line != null) 
            {
                ...
                customerList.add(new CustomerInformation(customerID, customerIC, customerName, gender, address, null, itemID, itemName, itemPrice, datePurchase));
                ...
                if (filteredItemCustomer.size() <= 5) 
                {
                    if (stateCounterNumber == 1) 
                    {
                        for (int j = 0; j < filteredItemCustomer.size(); j++) 
                        {
                            ...
                            String custGender = itemdata.getCustGender();
                            String custAddress = itemdata.getCustAddress();
            ...
            JOptionPane.showMessageDialog(null, "Read data successfully", "Completed!", JOptionPane.INFORMATION_MESSAGE);
            dispose();
